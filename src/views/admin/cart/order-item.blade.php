<div class="orderItem uk-margin-large-bottom ibox-content">
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-1-2">
                            ...
                            <div class="uk-form-row">
                                ...
                                <input type="text" value="{{ $data->get_user->tel }}" id="tel{{ $data->order_id }}" name="tel" class="uk-width-1-1">
                            </div>
                            <div class="uk-form-row">
                                <label class="uk-form-label" for="address{{ $data->order_id }}">Адрес доставки:</label>
                                <textarea class="not-editor uk-width-1-1" id="address{{ $data->order_id }}" name="address">{{ $data->get_user->address }}</textarea>
                            </div>
                            <div class="uk-form-row">
